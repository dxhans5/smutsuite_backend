...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensajes Personalizados (Registro y Edad)
    |--------------------------------------------------------------------------
    */

    'custom' => [
        'role.in' => 'El rol seleccionado no es válido.',
        'date_of_birth.required' => 'Tu fecha de nacimiento es obligatoria.',
        'date_of_birth.date' => 'Tu fecha de nacimiento debe ser una fecha válida.',
        'date_of_birth.age_check' => 'Debes tener al menos 21 años para registrarte.',
    ],

    /*
    |--------------------------------------------------------------------------
    | Atributos Personalizados (Etiquetas opcionales)
    |--------------------------------------------------------------------------
    */
